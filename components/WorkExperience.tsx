...
export default function WorkExperience({
  ...
  return (
    <div className="relative flex flex-col space-y-5 md:space-y-0 md:flex-row cursor-pointer max-w-5xl md:space-x-5 px-5 py-4 my-2  justify-start items-start border border-white border-b-[#F2f2f2]">
      <motion.div
